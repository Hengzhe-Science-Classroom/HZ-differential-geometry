// === Differential Geometry - Core Application ===
...
const App = {
    ...
    // --- Progress ---
    loadProgress() {
        try { this.progress = JSON.parse(localStorage.getItem('differential-geometry-progress') || '{}'); }
        catch (e) { this.progress = {}; }
    },
    saveProgress() {
        try { localStorage.setItem('differential-geometry-progress', JSON.stringify(this.progress)); } catch (e) {}
    },
